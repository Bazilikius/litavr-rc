 ...
 * - LORA_DIO0 moved to GPIO 34 (from GPIO 16) to avoid ESP32 flash/PSRAM memory bus interference on boot.
 */
...
// LoRa SPI Pin Configuration (DIO0 moved to GPIO 34 to avoid flashing/boot conflict)
#define LORA_SS    5
#define LORA_RST   14
#define LORA_DIO0  34
#define LORA_SCK   18
