...
### ⚠️ УВАГА: Важливе розв'язання помилки прошивання ("Failed to communicate with the flash chip")
Модуль LoRa **Ebyte E32 433T30D** є надпотужним передавачем на **1 Вт (30dBm)**, який у пікові моменти споживає до **600 мА** струму.
Коли ви прошиваєте ESP32 через USB-кабель від комп'ютера, стандартний USB-порт ПК не здатний видати такий великий струм одночасно для роботи спалаху пам'яті ESP32 та LoRa модуля. Це призводить до моментального просідання напруги 3.3В на платі, викликаючи збої запису: *"Warning: Failed to communicate with the flash chip"* або *"Serial data stream stopped: Possible serial noise or corruption"*.

**Регулярне та надійне вирішення:**
* **ОБОВ'ЯЗКОВО відключіть провід живлення VCC (5V/3.3V) LoRa-модуля Ebyte E32 на час прошивання плати по USB!** Після успішного завантаження коду підключіть провід живлення назад.
